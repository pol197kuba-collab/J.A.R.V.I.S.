  ...
  return (
    ...
    >
      ...
      >
        ...
        <circle cx="50" cy="50" r="38" fill="none" stroke="currentColor" strokeWidth="0.8" strokeDasharray="2 3" opacity="0.7" />
        {[0, 120, 240].map((rot) => (
          <g key={rot} transform={`rotate(${rot} 50 50)`} fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round">
