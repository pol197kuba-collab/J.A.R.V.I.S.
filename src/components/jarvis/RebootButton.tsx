...
export function RebootButton() {
  ...
  return (
    ...
    >
      <Zap
        strokeWidth={1.75}
        className="h-3.5 w-3.5 portrait:h-3 portrait:w-3 landscape:max-md:h-3 landscape:max-md:w-3"
      />
      <span className="portrait:hidden landscape:max-md:hidden">REBOOT SYSTEM</span>
