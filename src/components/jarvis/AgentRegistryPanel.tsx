...
export function AgentRegistryPanel({ agents }: { agents: AgentSummary[] }) {
  return (
    <div className="pointer-events-auto absolute left-4 top-16 max-h-[45vh] w-[220px] overflow-hidden rounded-lg border border-cyan-400/25 bg-black/60 shadow-[0_0_30px_-10px_rgba(77,216,255,0.5)] backdrop-blur-md sm:left-6 sm:top-20 sm:w-[260px]">
