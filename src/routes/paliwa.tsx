  ...
  return (
    <div className="space-y-6 p-6 @max-[420px]:space-y-4 @max-[420px]:p-4">
      ...
      >
        ...
        {/*
          Zapis sesją użytkownika to normalny stan tej instalacji (Supabase
          zarządzany przez Lovable, service_role poza zasięgiem), nie awaria —
          stąd neutralna informacja, a nie ostrzeżenie w kolorze statusu.
        */}
        {writeMode === "session" && (
          <p className="mt-3 min-w-0 break-words font-mono text-[10px] leading-relaxed text-muted-foreground">
            Cache zapisywany sesją zalogowanego użytkownika (aplikacja nie ma klucza service_role) —
            dane odświeżają się przy każdym wejściu na tę stronę. Pełna archiwizacja też zadziała,
            tylko potrwa dłużej niż z poziomu harmonogramu.
          </p>
        )}
      </HudPanel>
    </div>
