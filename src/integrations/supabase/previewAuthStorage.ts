...
export function brokeredPreviewStorage() {
  ...
  const request = (
    ...
    new Promise((resolve) => {
      ...
      let done = false;
      // Zainicjowany jawnie: bez tego `let` przypisywany dokładnie raz
      // łamie regułę prefer-const, a `const` nie wchodzi w grę, bo
      // clearTimeout(timer) w `finish` jest deklarowane WYŻEJ niż samo
      // ustawienie timera. clearTimeout(undefined) jest bezpieczne.
